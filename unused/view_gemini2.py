"""
Orbbec Gemini 2 专属 3D 视觉目标检测管线 (已适配外部 YAML 与 Models 目录)
特性：未检测到设备优雅退出、自动读取统一配置文件

用法：
    cd /home/chlorine/seeed/cameraws
    python scripts/yolo_gemini2_3d.py
"""
...
def main():
    ...
    model_name = yolo_cfg.get("model_name", "yolo11n.pt")
    ...
    if use_world and "world" in model_name.lower():
